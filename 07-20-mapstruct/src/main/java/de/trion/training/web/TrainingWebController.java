...
public class TrainingWebController {
   ...
   public TrainingWebController(AppProperties appProperties, TrainingRepository trainingRepository, TrainingMapper trainingMapper) {
   ...
   public ModelAndView trainings(Pageable pageable) {
      ...
      mav.addObject("trainings", trainingMapper.toDto(trainings.getContent()));
   ...
   public ModelAndView trainingEditConcurrent(ObjectOptimisticLockingFailureException ex, HttpServletRequest request) {
      ...
      mav.addObject("training", trainingMapper.toDto((Training)request.getAttribute("training")));
